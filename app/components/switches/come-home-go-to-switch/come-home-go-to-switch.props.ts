...
export interface SwitchProps {
  ...
  /**
   * Additional movingBlock styling when on.
   */
  movingBlockOnStyle?: StyleProp<ViewStyle>

  /**
   * Additional movingBlock styling when off.
   */
  movingBlockOffStyle?: StyleProp<ViewStyle>
}
